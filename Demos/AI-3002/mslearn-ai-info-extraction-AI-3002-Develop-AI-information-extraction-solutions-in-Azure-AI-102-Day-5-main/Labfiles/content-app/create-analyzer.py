...
def main():
    ...
    try:
        ...
        # Create the analyzer
        create_analyzer (card_schema, analyzer, ai_svc_endpoint, token.token)
...
def create_analyzer (schema, analyzer, endpoint, access_token):
    ...
    # initiate the analyzer creation operation using Bearer token authentication
    headers = {
